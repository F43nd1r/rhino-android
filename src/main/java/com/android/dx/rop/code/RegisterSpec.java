...
public final class RegisterSpec
     ...
     */
    private static String regString(int reg) {
        return PREFIX + reg;
    }
    ...
    public boolean equalsUsingSimpleType(RegisterSpec other) {
        return matchesVariable(other) && (reg == other.reg);
    ...
    public boolean matchesVariable(RegisterSpec other) {
        return other != null && type.getType().equals(other.type.getType()) && ((local == other.local) || ((local != null) && local.equals(other.local)));
