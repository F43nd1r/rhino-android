...
public final class SsaMethod {
    ...
    public static SsaMethod newFromRopMethod(RopMethod ropMethod,
                                             int paramWidth) {
        SsaMethod result = new SsaMethod(ropMethod, paramWidth);
     ...
     * method's parameters
     */
    private SsaMethod(RopMethod ropMethod, int paramWidth) {
    ...
    public ArrayList<SsaInsn>[] getUseListCopy() {
        ...
        ArrayList<SsaInsn>[] useListCopy
                = new ArrayList[registerCount];

        for (int i = 0; i < registerCount; i++) {
            useListCopy[i] = new ArrayList(useList[i]);
        }
