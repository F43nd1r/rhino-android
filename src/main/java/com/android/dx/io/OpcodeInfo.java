...
public final class OpcodeInfo {
     ...
     */
    private static Info get(int opcode) {
    ...
    public static class Info {
        ...
        public Info(int opcode, String name) {
            this.opcode = opcode;
            this.name = name;
        }
