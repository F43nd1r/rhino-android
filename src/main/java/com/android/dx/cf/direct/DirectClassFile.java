...
public class DirectClassFile implements ClassFile {
     ...
     * path-package consistency checking)
     */
    private DirectClassFile(ByteArray bytes, String filePath,
                            boolean strictParse) {
        if (bytes == null) {
    ...
    public TypeList makeTypeList(int offset, int size) {
        ...
        return new DcfTypeList(bytes, offset, size, pool);
    }
