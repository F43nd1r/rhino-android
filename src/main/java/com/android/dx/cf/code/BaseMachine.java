...
public abstract class BaseMachine implements Machine {
     ...
     * @return {@code null-ok;} the argument value
     */
    final ArrayList<Constant> getInitValues() {
     ...
     * called
     */
    final RegisterSpec getLocalTarget(boolean isMove) {
        if (localTarget == null) {
            return null;
        }
     ...
     */
    final void setResult(TypeBearer result) {
        if (result == null) {
     ...
     * @param result {@code non-null;} result value
     */
    final void addResult(TypeBearer result) {
        if (result == null) {
            throw new NullPointerException("result == null");
        }
     ...
     */
    final void storeResults(Frame frame) {
        if (resultCount < 0) {
            throw new SimException("results never set");
        }
