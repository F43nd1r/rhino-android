...
public abstract class InsnFormat {
     ...
     * @return {@code non-null;} the string form
     */
    protected abstract String insnArgString(DalvInsn insn);
     ...
     * @return {@code non-null;} the string form
     */
    protected abstract String insnCommentString(DalvInsn insn,
                                                boolean noteIndices);
     ...
     */
    private static void write(AnnotatedOutput out, short c0, short c1,
