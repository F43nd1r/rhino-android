...
final class Dops {
    ...
    private static final Dop CONST_STRING_JUMBO =
    ...
    private static final Dop FILLED_NEW_ARRAY_RANGE =
     ...
     */
    private static Dop get(int opcode) {
