...
public final class PositionList extends FixedSizeList {
    ...
    private static final PositionList EMPTY = new PositionList(0);
     ...
     */
    private static final int IMPORTANT = 3;
     ...
     */
    private void set(int n, Entry entry) {
        set0(n, entry);
    }
