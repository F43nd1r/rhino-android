...
public abstract class DalvInsn {
     ...
     */
    static SimpleInsn makeMove(SourcePosition position,
     ...
     * ins and outs)
     */
    DalvInsn(Dop opcode, SourcePosition position,
     ...
     * @return {@code non-null;} an appropriately-constructed instance
     */
    protected abstract DalvInsn withRegisters(RegisterSpecList registers);
