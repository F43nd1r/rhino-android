...
final class DebugInfoEncoder {
     ...
     * @throws IOException
     */
    private void emitStringIndex(CstString string) {
     ...
     * @throws IOException
     */
    private void emitTypeIndex(CstType type) {
     ...
     * @throws IOException
     */
    private void emitAdvanceLine(int deltaLines) {
        int mark = output.getCursor();
     ...
     * @throws IOException
     */
    private void emitAdvancePc(int deltaAddress) {
        int mark = output.getCursor();
     ...
     * @throws IOException
     */
    private void emitUnsignedLeb128(int n) {
