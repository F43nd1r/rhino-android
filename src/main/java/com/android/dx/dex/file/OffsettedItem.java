...
public abstract class OffsettedItem extends Item
     ...
     */
    OffsettedItem(int alignment, int writeSize) {
    ...
    public final boolean equals(Object other) {
        if (!(other instanceof OffsettedItem)) {
            return false;
        }
        if (this == other) {
            return true;
        ...
        return thisType == otherType && (compareTo0(otherItem) == 0);
     ...
     */
    final void setWriteSize(int writeSize) {
        if (writeSize < 0) {
     ...
     * section where this instance was placed
     */
    void place0(Section addedTo, int offset) {
