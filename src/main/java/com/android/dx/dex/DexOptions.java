...
public class DexOptions {
    ...
    */
    public final boolean ALIGN_64BIT_REGS_IN_OUTPUT_FINISHER = ALIGN_64BIT_REGS_SUPPORT;

    /** force generation of jumbo opcodes */
    public final boolean forceJumbo = false;
    ...
    public String getMagic() {
        /* target API level */
        return DexFormat.apiToMagic(DexFormat.API_NO_EXTENDED_OPCODES);
    }
}
