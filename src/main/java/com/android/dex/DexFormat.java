...
public final class DexFormat {
     ...
     * format
     */
    private static final int API_CURRENT = 14;
    ...
    private static final String MAGIC_SUFFIX = "\0";

    /** dex file version number for the current format variant */
    private static final String VERSION_CURRENT = "036";

    /** dex file version number for API level 13 and earlier */
    private static final String VERSION_FOR_API_13 = "035";
